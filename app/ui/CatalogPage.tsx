...
import { ArrowUp,Check,Info,Instagram,Minus,PackageOpen,Plus,Search,ShoppingBag,X } from "lucide-react";
...
export default function CatalogPage(){
 ...
 return <main className="catalog-page">
  ...
  {photo&&<PhotoViewer product={photo} onClose={()=>setPhoto(null)}>
   <strong>{money(photo.price)}</strong>
   <button type="button" className="add-cart" onClick={()=>{add(photo);setPhoto(null)}}><Plus/> Adicionar ao carrinho</button>
  </PhotoViewer>}
